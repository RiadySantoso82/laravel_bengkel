...
<div class="dashboard">
    ...
    <main class="main-content">
        <div class="page-header">
            <h1><i class="fas fa-toolbox"></i> Kategori Servis</h1>
            <a href="{{ route('service-categories.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
        </div>
            ...
            <div class="card-body">
                @if ($data->isEmpty())
                    <div class="empty-state">
                        ...
                        <h3>Belum ada kategori servis</h3>
                        <p>Tambahkan kategori servis atau isi dengan data default.</p>
                        <div class="empty-actions">
                            <form method="POST" action="{{ url('master/seed/service-categories') }}" style="display:inline;">
                                @csrf
                                <button class="btn btn-success"><i class="fas fa-database"></i> Isi Data Default</button>
                            </form>
                            <a href="{{ route('service-categories.create') }}" class="btn btn-outline"><i class="fas fa-plus"></i> Input Manual</a>
                        </div>
                    </div>
                @else
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="{{ route('service-categories.edit', $item) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        <form method="POST" action="{{ route('service-categories.destroy', $item) }}" onsubmit="confirmForm(this, 'Hapus data ini?')">
                                            @csrf @method('DELETE')

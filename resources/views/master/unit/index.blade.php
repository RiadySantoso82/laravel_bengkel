...
<div class="dashboard">
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <a href="{{ route('units.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
        </div>
            ...
            <div class="card-body">
                @if ($data->isEmpty())
                    <div class="empty-state">
                        ...
                        <p>Tambahkan satuan atau isi dengan data default.</p>
                        <div class="empty-actions">
                            <form method="POST" action="{{ url('master/seed/units') }}" style="display:inline;">
                                @csrf
                                <button class="btn btn-success"><i class="fas fa-database"></i> Isi Data Default</button>
                            </form>
                            <a href="{{ route('units.create') }}" class="btn btn-outline"><i class="fas fa-plus"></i> Input Manual</a>
                        </div>
                    </div>
                @else
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="{{ route('units.edit', $item) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        <form method="POST" action="{{ route('units.destroy', $item) }}" onsubmit="confirmForm(this, 'Hapus data ini?')">
                                            @csrf @method('DELETE')

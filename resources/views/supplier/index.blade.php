...
<div class="dashboard">
    ...
    <main class="main-content">
        <div class="page-header">
            <h1><i class="fas fa-truck-loading"></i> Supplier</h1>
            <a href="{{ route('suppliers.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
        </div>
        @if (session('success'))
            ...
            <div class="card-body">
                @if ($data->isEmpty())
                    <div style="text-align:center;padding:40px 20px;color:#94a3b8;">
                        <i class="fas fa-truck-loading" style="font-size:48px;margin-bottom:16px;"></i>
                        <h3 style="color:#475569;margin-bottom:8px;">Belum ada data supplier</h3>
                        <p style="margin-bottom:24px;font-size:14px;">Isi dengan data demo atau input manual.</p>
                        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;margin-bottom:20px;">
                            <form method="POST" action="{{ route('suppliers.demo') }}" style="display:inline;">
                        ...
                        <a href="{{ route('suppliers.create') }}" class="btn btn-primary" style="background:#0f3460;color:#fff;"><i class="fas fa-plus"></i> Input Manual</a>
                    </div>
                @else
                    <table>
                        <thead><tr><th>No</th><th>Nama</th><th>Telepon</th><th>Kontak Person</th><th>Aksi</th></tr></thead>
                        <tbody>
